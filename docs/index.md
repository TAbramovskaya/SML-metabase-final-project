...
We will perform an RFM analysis on the dataset. A set of 2 285 customers will be selected for the analysis, we will assign scores to them according to the RFM methodology and then divide them into segments based on behavioral patterns to work with them more effectively. Proceed directly to the [RFM calculation methodology](rfm_calculation_methodology.md).
