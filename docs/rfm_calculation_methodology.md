...
![](images/recency_scores.png){ style="display:block; margin-left:auto; margin-right:auto; width:80%;" }
...
![](images/frequency_scores.png){ style="display:block; margin-left:auto; margin-right:auto; width:80%;" }
...
![](images/monetary_scores.png){ style="display:block; margin-left:auto; margin-right:auto; width:80%;" }
